...
type
  ...
  private
    ...
    // --- NOVO: Handler auxiliar estático para criar planilha ---
  ...
  public
    ...
    // --- NOVO: Método de instância para lidar com a criação de planilha ---
...
uses
  ...
  UViewCompartilhamento, System.UITypes, UViewSelecionarPlanilhaParaTabela,
